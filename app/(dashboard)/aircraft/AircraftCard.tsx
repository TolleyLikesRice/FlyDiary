...
export default function AircraftCard({ aircraft }: { aircraft: Aircraft }) {
    ...
    // TODO: use a better image than some random one of google
    ...
    return (
        <Card className="w-[350px] h-full">
            <div className="w-full h-full rounded-xl overflow-clip">
                    ...
                    <div className="w-full text-right text-[0.5rem] p-0.5 pr-2 text-neutral-300 bg-slate-80">Photo by {photoData.photographer}, sourced from <a className="underline hover:text-blue-400" href={photoData.link}>PlaneSpotters.net</a></div>
